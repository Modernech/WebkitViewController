...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of WebkitViewController."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/WebkitViewController"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Masahiro Watanabe" => "m@nsocean.org" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/WebkitViewController.git", :tag => s.version.to_s }
